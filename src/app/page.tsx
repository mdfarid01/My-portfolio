...
import { fadeInUpAnimation } from "@/lib/animations" // maps to Tailwind class
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-20">
        {/* Hero Section */}
        <section className={`text-center mb-32 ${fadeInUpAnimation}`}>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center mb-32">
          <div className={`animate-fade-in-up stagger-3`}>
            <h2 className="text-3xl font-bold mb-4 text-foreground">What I Build</h2>
